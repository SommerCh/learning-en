    ...
    return (
        <>        
            ...
            <section className="article-cntr"> 
                {products
                .filter((product) => product.MainCategory.Id === 6 || product.Keywords.includes('stole')) // Displays products with the related main-category id and related keyword
                .map((product) => ( 
