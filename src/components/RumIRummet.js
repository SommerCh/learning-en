...
export default function RumIRummet() {
    ...
    return (
        <>             
            ...
            <section className="article-cntr"> 
                {products
                .filter((product) => product.MainCategory.Id === 8 || product.Keywords.includes('rum i rummet')) // Displays products with the related main-category id and related keyword
                .map((product) => ( 
