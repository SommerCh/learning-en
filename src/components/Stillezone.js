...
export default function Stillezone() {
    ...
    return (
        <>             
            ...
            <section className="article-cntr"> 
                {products
                .filter((product) => product.MainCategory.Id === 11 || product.Keywords.includes('stillezone')) // Displays products with the related main-category id and related keyword
                .map((product) => ( 
