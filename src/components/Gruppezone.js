...
export default function Gruppezone() {
    ...
    return (
        <>             
            ...
            <section className="article-cntr"> 
                {products
                .filter((product) => product.MainCategory.Id === 12 || product.Keywords.includes('gruppezone')) // Displays products with the related main-category id and related keyword
                .map((product) => ( 
